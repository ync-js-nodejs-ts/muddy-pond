...
export const IconArrowRight = ({
  ...
  return (
    <svg width={width} height={height} viewBox='0 0 512 512' fill={fill} stroke={stroke} className={classes}>
      <g>
        <g>
          <path
            d='M256,0C114.859,0,0,114.837,0,256c0,141.141,114.859,256,256,256c141.163,0,256-114.859,256-256
